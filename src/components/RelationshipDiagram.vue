...
<template>
  <div
    v-if="show"
    class="h-full flex flex-col bg-slate-50 dark:bg-slate-800/50"
  >
    <!-- Header -->
    <div class="flex items-center gap-2 px-3 py-2 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
      <Link :size="14" class="text-blue-500" />
      <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">Relationships</span>
      <span class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 text-[10px] rounded-full font-bold">
    ...
    <!-- Footer hint -->
    <div class="px-2 py-1.5 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
